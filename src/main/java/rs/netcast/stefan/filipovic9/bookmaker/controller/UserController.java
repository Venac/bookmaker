...
public class UserController {
	...
	@PostMapping("/save")
	public UserNoPassDto saveUser(@Valid @RequestBody UserNoIdDto user) throws IOException {
	...
	@PutMapping("/update")
	public PasswordDto updateUser(@Valid @RequestBody PasswordDto password, HttpServletRequest request) {
	...
	public TransactionNoUserDto addFunds(@Valid @RequestBody TransactionAmountCurrencyDto t, HttpServletRequest request) throws IOException {
		int idUser = (int) request.getAttribute("id");
		return transactionService.addFunds(t, idUser);
	}
	
	@PostMapping("/withdrawFunds")	
	public TransactionNoUserDto withdrawFunds(@Valid @RequestBody TransactionAmountCurrencyDto t, HttpServletRequest request) throws IOException {
		int idUser = (int) request.getAttribute("id");
		return transactionService.withdrawFunds(t, idUser);
	}
	
	@PostMapping("/period")
	public List<TransactionNoUserDto> viewTransactionsBetween(@Valid @RequestBody TimePeriodDto p, HttpServletRequest request) {
		int idUser = (int) request.getAttribute("id");
